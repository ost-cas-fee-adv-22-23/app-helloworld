    ...
    <>
      <div className="grid grid-cols-1 mt-xl">
        ...
        <div className="mt-xxxs">
          <Textfield placeholder="Und was meinst du dazu?" value={''} onChange={undefined} />
        </div>
        <div className="flex flex-row gap-l justify-between unset">
          <Button label="Bild hochladen" size="L" variant="default">
            <UploadIcon size={16} />
          </Button>
          <Button label="Absenden" size="L" variant="purple" onClick={undefined}>
            <SendIcon size={16} />
          </Button>
        </div>
      </div>
